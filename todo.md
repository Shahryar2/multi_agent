...
2. 刷新后台还在搜索中没有停止
3. 没有查看历史研究的按钮和布局设计
4. 主页应该设置顶部栏或侧边栏用于查看登录用户信息，包括历史对话、收藏信息等
5. 研究过程中可以不要系统的对话框的头像，直接输出，美观就好
6. 研究过程展示思考等的目的就是不要什么都不做呆在那里（这是重点！！！！！）
7. 研究过程中的右侧展示栏太丑了，参考整体的风格做调整，边框不要方正的
8. 前端页面关于研究资料库为空
9. 研究页面输出思考、研究，展示的搜索到的页面内容和图片以及最终的研究文档几个部分要做一点点区别
    比如背景、字体颜色、框选的设计区别
10. 确认方向和计划时除了批准并执行并没有其他选项，修改或者打回

11. 区分随便闲聊和需要搜索的场景功能，随便发句 “你好” 就不要思考半天了吧
12. 想要的是将后端系统进行的转化为用户可看的md形式的，类似于看得到系统思考的过程，而不是等最后把东西直接放在前端页面，是要动起来
